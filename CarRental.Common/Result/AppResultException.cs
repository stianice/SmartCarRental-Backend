...
{
    public static AppResultException Status200OK(
    ...
    public static AppResultException Status400BadRequest(
    ...
    public static AppResultException Status401Unauthorized(
    ...
    public static AppResultException Status403Forbidden(
    ...
    public static AppResultException Status404NotFound(
    ...
    public static AppResultException Status409Conflict(
    ...
    public static AppResultException Status500InternalServerError(
